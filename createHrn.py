...
doc.add(dominate.tags.comment("Generated by " + sys.argv[0] + " on " + str(datetime.today())))
doc.add(dominate.tags.comment("Source code: https://github.com/VlatkoPrimorac/HumanReadableNews/"))
doc.body["text"]    = "White"
doc.body["link"]    = "Green"
